...
public class Graph {
    ...
    */
    public Vertex CreateVertex(String Label,int i) {
        Vertex vertex = new Location(Label,i);
    ...
    */
    public Edge CreateEdge(Vertex source, Vertex destenation, int weight) {
        Edge edge = new Route(source, destenation, weight);
        return edge;
    }
    /*
    ...
    */
    ...
    /*
    make_graph is a method used by requirement 2 to make a randomized graph
    */
    public void make_graph(Graph graph) {
        ...
        for (int i = 0; i < graph.veticesNo; i++) {
            ...
            Vertex v1=CreateVertex(vertexLabel,i);
            v1.setIndex(i);
        }//end of for loop 
